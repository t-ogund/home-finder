                ...
                <Row className='input-row'>
                    ...
                    <Form onSubmit={handleSubmit} className='form-container input-box'>
                        <InputGroup className='mb-3 d-flex'>
                            <Form.Control style={{ border: '1px solid white' }} aria-describedby="basic-addon2" onChange={(e) => dispatch(setInput(e.target.value))} className='p-3' type='text' placeholder='Enter city or ZIP code' />
